...
<table width="760px" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td>
			<form id="form2" method="post" style="margin:0px" action="buscador.php">
				<?php
				    $clase1 = "link_blanco_sel";
					$clase2 = "link_blanco";
					$clase3 = "link_blanco";

				    if( isset( $_GET["noti"] ) || isset( $_GET["rec"] ) ){
				    	$clase1 = "link_blanco";

						if( isset( $_GET["noti"] ) )
							$clase2 = "link_blanco_sel";
						else
							$clase3 = "link_blanco_sel";
				    }
					
					$texto = "<a id='lnkInicio' href='principal.php' class='" . $clase1 . "'>Inicio</a>&nbsp;-&nbsp;" .
							 "<a href='organizacion.php' class='link_blanco'>Organización</a>&nbsp;-&nbsp;" .
							 "<a href='servicios.php' class='link_blanco'>Servicios</a>&nbsp;-&nbsp;" .
							 "<a id='lnkNoticias' href='javascript:verNoticias(1)' class='" . $clase2 . "'>Noticias</a>&nbsp;-&nbsp;" .
							 "<a id='lnkUltimas' href='javascript:verNoticias(2)' class='" . $clase3 . "' title='ÚLTIMAS NORMAS ACTUALIZADAS O DESARROLLADAS'>Últimas Normas</a>";
								...
								<form id="form1" method="post" style="margin:0px" action="buscador.php">
									...
									<table cellpadding="0" cellspacing="0" border="0">
										...
										<tr>
											...
											<td width="130px">
												<input type="text" name="txtBuscar"  value="" size="19" class="Detalle" maxlength="100" />
											</td>
											<td width="80px">
										...
										<tr>
											...
											<td colspan="2">
												<table cellpadding="0" cellspacing="0" border="0">
													<tr>
														<td>
				                                            <input type="checkbox" name="chkBuscarTitulo" id="chkBuscarTitulo" checked>
														</td>
														<td>
													...
													<tr>
														<td>
				                                            <input type="checkbox" name="chkBuscarCodigo" id="chkBuscarCodigo">
														</td>
														<td>
