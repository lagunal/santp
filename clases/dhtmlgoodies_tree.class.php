...
class dhtmlgoodies_tree{
	...
	function writeJavascript()
	{
		...
		*/		
		var plusNode = '../imagenes/dhtmlgoodies_plus.gif';
		var minusNode = '../imagenes/dhtmlgoodies_minus.gif';
	...
	*/
	...
	function addToArray($id,$name,$parentID,$url="",$target="",$imageIcon="../imagenes/dhtmlgoodies_folder.gif"){
	...
	function drawSubNode($parentID){
		if(isset($this->elementArray[$parentID])){			
			...
			for($no=0;$no<count($this->elementArray[$parentID]);$no++){
				...
				echo "<li class=\"tree_node\"><img class=\"tree_plusminus\" id=\"plusMinus".$this->elementArray[$parentID][$no][0]."\" src=\"../imagenes/dhtmlgoodies_plus.gif\"><img src=\"".$this->elementArray[$parentID][$no][4]."\"><a class=\"tree_link\"$urlAdd>".$this->elementArray[$parentID][$no][1]."</a>";
				//echo "<li class=\"tree_node\"><img class=\"tree_plusminus\" id=\"plusMinus".$this->elementArray[$parentID][$no][0]."\" src=\"../imagenes/dhtmlgoodies_plus.gif\"><a class=\"tree_link\"$urlAdd>".$this->elementArray[$parentID][$no][1]."</a>";
	...
	function drawTree(){
		...
		for($no=0;$no<count($this->elementArray[0]);$no++){
			...
			//echo "<li class=\"tree_node\" id=\"node_".$this->elementArray[0][$no][0]."\"><img id=\"plusMinus".$this->elementArray[0][$no][0]."\" class=\"tree_plusminus\" src=\"../imagenes/dhtmlgoodies_plus.gif\"><img src=\"".$this->elementArray[0][$no][4]."\"><a class=\"tree_link\"$urlAdd>".$this->elementArray[0][$no][1]."</a>";
			echo "<li><img id=\"plusMinus".$this->elementArray[0][$no][0]."\" style='display:none'>";
